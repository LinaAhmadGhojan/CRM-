                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                    ...
                                    <input required name="name" required type="text" class="form-control" id="password" aria-describedby="emailHelp">
                            </div>

                            <div class="mb-3">
                                <label for="password" class="form-label"> Email</label>
                                <input required name="email" required type="email" class="form-control" id="password" aria-describedby="emailHelp">
                           </div>

                           <div class="mb-3">
                            <label for="password" class="form-label"> Email</label>
                            <input required name="password" required type="password" class="form-control" id="password" aria-describedby="emailHelp">
                       </div>

                           <div class="mb-3">
                            <label for="password" class="form-label">Phone</label>
                            <input name="phone"  required type="text" class="form-control" id="password" aria-describedby="emailHelp">
                         </div>
