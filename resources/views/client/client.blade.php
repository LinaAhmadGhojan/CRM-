                                    ...
                                    <table class="table app-table-hover mb-0 text-left">
                                        <thead>
                                            <tr style="background-color: #5b84c5;">
                                                ...
                                                <th class="cell">personal image</th>
                                                ...
                                                <tr style="background-color: #a6bee3;">
                                                    ...
                                                    <td class="cell"><span class="truncate">
                                                            <img style="height: 100px;width: 100px"
                                                                src="{{ asset('image/client') }}/{{ $item->image }}"
                                                                alt="">
                                                    </td>

                                                    <td class="cell">{{ $item->email }}</td>
                                                    <td class="cell"><span>{{ $item->phone }}</span></td>
                                                    <td>
                                                        <a href="{{ route('delete.client', ['id' => $item->id]) }}"
                                                            style="color: #dc3545" class="btn btn-light">delete</a>
                                                        <a href="{{ route('edit.client', ['id' => $item->id]) }}"
                                                            style="color: #2b63bc" class="btn btn-light">edit</a>
                                                    </td>
