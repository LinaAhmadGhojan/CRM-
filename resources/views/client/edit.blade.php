        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <div class="col-md-9 mx-auto">
                    ...
                    <form action="{{ route('post.edit.client',['id'=>$client->id])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                    ...
                                    <input required value="{{ $client->name }}" name="name" required type="text" class="form-control" id="password" aria-describedby="emailHelp">
                            </div>

                            <div class="mb-3">
                                <label for="password" class="form-label"> Email</label>
                                <input value="{{ $client->email }}" required name="email" required type="email" class="form-control" id="password" aria-describedby="emailHelp">
                           </div>


                           <div class="mb-3">
                            <label for="password" class="form-label">Phone</label>
                            <input name="phone"  value="{{ $client->phone }}" required type="text" class="form-control" id="password" aria-describedby="emailHelp">
                         </div>
