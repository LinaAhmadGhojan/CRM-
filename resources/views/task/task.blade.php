                                        ...
                                        <tbody>
                                            @foreach ($tasks as $item)
                                                <tr style="background-color: #a6bee3;">
                                                    ...
                                                    <td class="cell">
                                                        <span>{{ \App\Models\User::find($item->assigned_user)->name }}</span>
                                                    </td>
                                                    <td class="cell">
                                                        <span>{{ \App\Models\Project::find($item->id_project)->title }}</span>
                                                    </td>
                                                    <td class="cell"><span>{{ $item->status }}</span></td>

                                                    <td>
                                                        <a href="{{ route('delete.task', ['id' => $item->id]) }}"
                                                            style="color: #dc3545" class="btn btn-light">delete</a>
                                                        <br>
                                                        <a href="{{ route('edit.task', ['id' => $item->id]) }}"
                                                            style="color: #2b63bc;    margin-top: 11px; "
