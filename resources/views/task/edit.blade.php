        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <div class="col-md-10 mx-auto">
                    ...
                    <form action="{{ route('post.edit.task', ['id' => $task->id]) }}" method="POST"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input required value="{{ $task->title }}" name="title" required
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea style="height: 100px;" required name="description" required type="text" class="form-control"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input value="{{ $task->deadline }}" name="deadline" required type="date"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="id_project" required type="file" class="form-control"
                                        id="password" aria-describedby="emailHelp">
