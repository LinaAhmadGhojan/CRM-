        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <div class="col-md-10 mx-auto">
                    ...
                    <form action="{{ route('post.edit.project', ['id' => $project->id]) }}" method="POST"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input value="{{ $project->title }}" required name="title" required
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea style="height: 200px;" required name="description" required type="text" class="form-control"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input value="{{ $project->deadline }}" name="deadline" required type="date"
                                        class="form-control" id="password" aria-describedby="emailHelp">
                                </div>


                                <div class="mb-3">
                                    <label for="password" class="form-label">Assigned Uer</label>
                                    <select name="assigned_user" required type="file" class="form-control"
                                        id="password" aria-describedby="emailHelp">
                                ...
                                <div class="mb-3">
                                    <label for="password" class="form-label">Assigned Client</label>
                                    <select name="assigned_client" required type="file" class="form-control"
                                        id="password" aria-describedby="emailHelp">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name=" status" required type="file" class="form-control"
                                        id="password" aria-describedby="emailHelp">
                                        <option value="start">start</option>
                                        <option value="done">done</option>
                                        <option value="inprossing">inprossing</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    <button class="btn btn-primary" style="    background-color: #0d6efd; ">Next >>
                                    </button>
                                </div>
                            </div>
